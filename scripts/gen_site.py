...
.ap-steps{list-style:none;margin:26px 0 0;padding:0;counter-reset:s;
display:grid;grid-template-columns:repeat(3,1fr);gap:clamp(14px,1.8vw,24px)}
.ap-steps li{counter-increment:s;display:flex;flex-direction:column;padding:0;border:0;
background:var(--soft);border-radius:16px;padding:clamp(16px,1.8vw,22px);min-width:0}
.ap-steps li::before{content:counter(s);flex:0 0 auto;width:26px;height:26px;border-radius:50%;
background:var(--ink);color:#fff;font-size:12.5px;font-weight:700;
display:flex;align-items:center;justify-content:center;margin-bottom:12px}
.ap-steps .t{font-size:15.5px;font-weight:700;letter-spacing:-.03em;color:var(--ink)}
.ap-steps .d{font-size:14px;color:var(--gray);margin-top:6px;line-height:1.65}
