...
background:#14161a;border-bottom:1px solid rgba(255,255,255,.08);
box-shadow:0 28px 56px -30px rgba(0,0,0,.7);
...
def shell_bar_markup(host="", act_extra=""):
    ...
    parts.append(f'<a class="mmt-it mmt-trg" href="https://the-moment.us/products/">더보기</a>')
